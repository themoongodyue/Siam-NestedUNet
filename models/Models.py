...
# @Software: PyCharm
# @Brief: Siam NestedUNet model implement
# @reference: https://github.com/likyoo/Siam-NestedUNet
...
class up(nn.Module):
    def __init__(self, in_ch, method):
        ...
        if method == "bilinear":
            ...
            raise Exception("You must select one of the ['bilinear', 'transpose'].")
...
class SNUNet_ECAM(nn.Module):
    # SNUNet-CD with ECAM
    def __init__(self, n, in_ch=3, out_ch=2, method="bilinear"):
        ...
        self.Up1_0 = up(filters[1], method)
        self.conv2_0 = conv_block_nested(filters[1], filters[2], filters[2])
        self.Up2_0 = up(filters[2], method)
        self.conv3_0 = conv_block_nested(filters[2], filters[3], filters[3])
        self.Up3_0 = up(filters[3], method)
        self.conv4_0 = conv_block_nested(filters[3], filters[4], filters[4])
        self.Up4_0 = up(filters[4], method)
        ...
        self.Up1_3 = up(filters[1], method)
